...
from app.identity.domain.exceptions import UserAlreadyExistsError, InvalidCredentialsError, UserInactiveError
from app.identity.domain.interfaces import UserCommandRepositoryProtocol, UserQueryRepositoryProtocol
...
from app.identity.dto.user_dto import UserCreateRequestDTO, UserUpdateRequestDTO, UserPasswordChangeRequestDTO
